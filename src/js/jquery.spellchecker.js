 ...
 */
 ...
 (function(window, $) {
  ...
  Parser.prototype.clean = function(text) {
    ...
    text += ''; // Typecast to string to prevent exceptions
    ...
    // text = XRegExp.replace(text, reg, ' ');


    // var reg = XRegExp('\\p{P}', 'g'); text = "Εδώ είναι. κάποιες 'λέξεις'";
    // text = XRegExp.replace(text, reg, ' ').replace(/\s{2,}/g, ' ');
